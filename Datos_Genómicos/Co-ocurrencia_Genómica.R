########################################
## Análisis de co-ocurrencia genómica ##
########################################
...
pheatmap(cor_matrix, 
         main = "Co-ocurrencia genómica en cáncer", 
         color = custom_colors, 
         breaks = seq(0, +1, length.out = 50))  # Ajustar los puntos de interrupción para el rango de -10 a +5
