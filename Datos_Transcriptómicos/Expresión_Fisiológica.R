#######################################################
## Análisis de expresión transcriptómica fisiológica ##
#######################################################
...
custom_colors <- colorRampPalette(c("white", "#2E6F40"))(260)
pheatmap(cor_matrix, 
         main = "Expresión fisiológica", 
         color = custom_colors, 
         breaks = seq(0, +150, length.out = 260))  # Ajustar los puntos de interrupción para el rango de -10 a +5
